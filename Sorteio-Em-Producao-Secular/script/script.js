...
const butVoltarTodos =  document.getElementById('butVoltarTodos');
...
let cabecarioLimparTudo = ""; let nomeDisponivel = ""; 
let cabecarioLimparCadastrados = ""; let erroExcluirCadastrado = "";
let modalLimparCadastrados = ""; let erroExcluirTodosCadastrados = "";
...
let erroNumSequencia6 = "";let erroNomeImportado = ""; let retornaTodosDaEspera = "";
...
let modalExportPermanente = ""; let cabecarioExportPermanente = ""; let gerandoPre = ""; let erroEspera = "";
...
const LANG = {
    pt: {
        ...
        title_silenciar: "Silenciar a música",
    ...
    en: {
        ...
        title_silenciar: "Mute the music",
    ...
    es: {
        ...
        title_silenciar: "Silenciar la música",
...
function mudarIdioma(){
    if(idiomaAtual === 'pt'){
        ...
        cabecarioExportarTudo ="EXPORTAR BACKUP";
        cabecarioNumSequencia = "GERAR NÚMEROS";
        cabecarioLimparTudo = "LIMPAR TUDO";
        cabecarioLimparEspera = "LIMPAR LISTA DE ESPERA";
        ...
        erroEspera = "Lista de Espera vazia.";
        erroAudio = "Não foi possível iniciar o áudio";
        erroExcluirTodosCadastrados = "Todos os cadastrados foram excluídos";
        erroExcluirCadastrado = "O nome foi excluído.";
        erroPreenchimento = "Preencha os campos nome e cidade.";
        erroReiniciar = "Não há nada para reiniciar.";
        ...
        modalFoto = "Clique em <span class='confirm'><b>CONFIRMAR</b></span><br><br>Se ministério e o texto estiverem correto.<br><br>Ministério: <span style='color: #0655aa;font-weight:bold;'>";
        ...
        modalExportarTudo = "Para exportar:<br><br><b><span style='color: #0655aa;'>TODO O BACKUP DO SORTEIO</span></b>";
        ...
        retornaTodosDaEspera = "Para retornar Todos os nomes da <span style='color: #0655aa;'><b>Lista de Espera</b></span><br><br>Para a <span style='color: #0655aa;'><b>Lista de Participantes.</b></span>";
        ...
        cabecarioExportarTudo ="EXPORT BACKUP";
        cabecarioNumSequencia = "GENERATE NUMBERS";
        cabecarioLimparTudo = "CLEAR ALL";
        cabecarioLimparEspera = "CLEAR WAITING LIST";
        ...
        exportList = "Exported:";
        erroEspera = "Lista de Espera vazia.";
        erroAudio = "Coud not start the audio.";
        erroExcluirTodosCadastrados = "All registered users have been excluded.";
        erroExcluirCadastrado = "The name was excluded.";
        erroPreenchimento = "Fill in the name and city fields.";
        erroReiniciar = "There is nothing to restart.";
        ...
        modalExportarTudo = "To export:<br><br><b><span style='color: #0655aa;'>THE ENTIRE DRAW BACKUP</span></b>";
        ...
        retornaTodosDaEspera = "To return all names from the <span style='color: #0655aa;'><b>Waiting List</b></span><br><br>To the <span style='color: #0655aa;'><b>Participants List.</b></span>";
        ...
        cabecarioImportarTudo ="IMPORTAR BACKUP";
        cabecarioExportarTudo ="EXPORTAR COPIA DE SEGURIDAD";
        cabecarioNumSequencia = "GENERAR NÚMEROS";
        cabecarioLimparTudo = "LIMPIAR TODO";
        cabecarioLimparEspera = "LIMPIAR LISTA DE ESPERA";
        ...
        exportList = "Exportados:";
        erroEspera = "Lista de Espera vazia.";
        erroAudio = "No se pudo iniciar el audio.";
        erroExcluirTodosCadastrados = "Todos los registrados fueron excluidos.";
        erroExcluirCadastrado = "El nombre fue excluido.";
        erroPreenchimento = "Complete los campos nombre y ciudad.";
        erroReiniciar = "No hay nada para reiniciar.";
        ...
        modalExportarTudo = "Para exportar:<br><br><b><span style='color: #0655aa;'>TODO EL RESPALDO DEL SORTEO</span></b>";

        nomeHistorico = "Historial";
        nomeCadastrado = "ya está registrado.";
        nomesDisponiveis = "nombres";
        nomeDisponivel = "nombre";
        ...
        retornaTodosDaEspera = "Para devolver Todos los nombres de la <span style='color: #0655aa;'><b>Lista de Espera</b></span><br><br>A la <span style='color: #0655aa;'><b>Lista de Participantes.</b></span>";
...
function salvarImagem() {
    ...
    const minFoto = localStorage.getItem('nomeMinisterio') || '';
    const textFoto = localStorage.getItem('nomeTexto') || '';
...
// AO CLICAR NO CAMPO DE CADASTRO DE NOMES, LIMPA OS OUTROS CAMPOS
inputCadastrado.addEventListener('click', function(e) {
    // Campo cadastro de numeros e CPF
    inputNumero.value = '';
    // Campo cadastro de numeros aleatorios
    inputNumerosAleatorios.value = '';
    // Campo cadastro de numeros sequenciais
    inputNumeros.value = '';
    // Campo busca
    inputPesquisa.value = '';
});

// AO CLICAR NO CAMPO DE CADASTRO DE NUMEROS E CPF, SSN E NIF, LIMPA OS OUTROS CAMPOS
inputNumero.addEventListener('click', function(e) {
    // Campo cadastro de nomes
...
// AO CLICAR NO CAMPO DE PESQUISA, LIMPA OS OUTROS CAMPOS
inputPesquisa.addEventListener('click', function(e) {
    // Campo cadastro de nomes
    inputCadastrado.value = '';
    // Campo cadastro de numeros aleatorios
    inputNumerosAleatorios.value = '';
...
// AO CLICAR NO CAMPO NUMEROS ALEATORIOS, LIMPA OS OUTROS CAMPOS
inputNumerosAleatorios.addEventListener('click', function(e) {
    // Campo cadastro de nomes
    inputCadastrado.value = '';
    // Campo pesquisa
    inputPesquisa.value = '';
...
// AO CLICAR NO CAMPO NUMEROS SEQUENCIAIS, LIMPA OS OUTROS CAMPOS
inputNumeros.addEventListener('click', function(e) {
    // Campo cadastro de nomes
    ...
    // Campo cadastro de numeros aleatorios
    if(inputNumerosAleatorios.value !== ''){
        inputNumerosAleatorios.value = '';
    }
    // Campo cadastro de numeros e CPF
...
inputNumero.addEventListener('input', function(e) {
    // Ao digitar cinco numeros no campo, oculta o batao CAD
    ...
    // Valida o CAMPO CPF AO DIGITAR quando a linguagem for em Portugues
    if(idiomaAtual === 'pt'){
        if(!/^\d+$/.test(inputNumero.value) && inputNumero.value.length > 0){
            // Mostra a mensagem de erro de SSN invalido
    ...
    // Valida o CAMPO SSN AO DIGITAR quando a linguagem for em Ingles
     if(idiomaAtual === 'en'){
        // Depois de 5 caracteres aparece a mensagem para completar o SSN
        if(inputNumero.value.length > 5 && /^\d+$/.test(inputNumero.value)){
            // Pede para continuar digitando o SSN
    ...
    // Valida o CAMPO NIF AO DIGITAR quando a linguagem for espanhol
    if(idiomaAtual === 'es'){
        ...
        let nono = valorNIF[8] || "";
        // Ate 5 caracteres, so mostra erro se digitar alguma letra
        if(inputNumero.value.length <= 5 && /[A-Z]/.test(primeiros8)){
            travaInput(inputNumero, `⚠️ Apenas numeros nos primeiros 8 caracteres`);
        }
        // Depois de 5 caracteres aparece a mensagem para completar o NIF, se digitar letra, aparece a mensagem abaixo
        if(inputNumero.value.length > 5 ){
            if(/[A-Z]/.test(primeiros8)){
                travaInput(inputNumero, `⚠️ Apenas numeros nos primeiros 8 caracteres`);
            }else{
                // Mensagem completar o NIF
                mostrarErro(`⚠️ ${erroCPF}`);
            }  
        }
        // Depois de digitar 8 numeros, se digitar numero, aparece a mensagem abaixo
        if(/\d/.test(nono)){
    ...
    }if(inputNumero.value.length > 5 && inputNumero.value.length < 11 && idiomaAtual === 'pt'){
        inputNumero.classList.remove('cpf-ok');
        mostrarErro(`⚠️ ${erroCPF}`);
    }
...
function pesquisarCadastrado(termo){
    ...
    itens.forEach(item => {
        ...
        let termoNome = ' ' + nomesDisponiveis;
        if(encontrados === 1){
            termoNome = ' ' + nomeDisponivel;
        }
        contarCadastrados.innerText = encontrados + termoNome;
    });
    if(encontrados === 0){
...
function exportarTudo() {
    if(cadastrados.length > 0){
        cabecario.innerHTML =`<span style='float:left'>📤</span> ${cabecarioExportarTudo}`;
        modal.innerHTML = `<br>${confirma}<br><br>${modalExportarTudo}`;
        confirme.innerHTML = `✅&nbsp&nbsp ${confirmar}`;
        confirme.style.display = 'block';
        modalHistorico();
        confirme.onclick = () => {
...
function deletarCadastro(index) {
    ...
    confirme.onclick = () => {
        ...
        atualizarContadorCadastrados();
        fechar();
        mostrarErro(`✅ ${erroExcluirCadastrado}`);
    }
}
...
function atualizarContadorCadastrados() {
    if(cadastrados.length > 0){
        ...
        let termoName = '';
        if(idiomaAtual === 'pt'){
            if(cadastrados.length - nomes.length <= 1){
                termoCadastrado = 'disponível';
            }else{
                termoCadastrado = 'disponíveis';
            }
            ...
            contarCadastrados.textContent = `${cadastrados.length} ${termoName} | ${cadastrados.length - nomes.length} ${termoCadastrado}`;
        }else if(idiomaAtual === 'en'){
             if(cadastrados.length <= 1){
                termoName =  'name';
            }else{
            ...
            contarCadastrados.textContent = `${cadastrados.length} ${termoName} | ${cadastrados.length - nomes.length} available`;
        }else{
            if(cadastrados.length - nomes.length <= 1){
                termoCadastrado = 'disponible';
            }else{
                termoCadastrado = 'disponibles';
            }
            if(cadastrados.length <= 1){
                termoName =  'nombre';
            }else{
...
function atualizarStatusOverlay() {
    ...
    let sor = 'sorteados';
    let win = 'winners';
    if(disponiveis.length <= 1){rest = 'restante'};
    if(nomesSorteados.length <=1){sor = 'sorteado'};
    if(idiomaAtual === 'pt'){
        statusOverlay.textContent = `${disponiveis.length} ${rest} | ${nomesSorteados.length} ${sor}`;
    }else if(idiomaAtual === 'en'){
        if(nomesSorteados.length <=1 ){win = 'winner'};
        statusOverlay.textContent = `${disponiveis.length} remaining | ${nomesSorteados.length} ${win}`;
    }else{
        statusOverlay.textContent = `${disponiveis.length} ${rest} | ${nomesSorteados.length} ${sor}`;
    }
}
...
// Funcao que retorna todos os nomes da lista de espera
// para a lista de participantes, de uma so vez
function retornarTodosDaEspera() {
    cabecario.innerHTML = `<span style='float:left'>🗑️</span> ${cabecarioLimparEspera}<br>`; 
    modal.innerHTML = `⚠️ ${atencao}<br><br>${confirma}<br><br>${retornaTodosDaEspera}<br><br> Total: ${listaEspera.length} ${nomesDisponiveis}.`;
    confirme.innerHTML = `✅&nbsp&nbsp ${confirmar}`;
    confirme.style.display = 'block';
    modalHistorico();
    confirme.onclick = () => {
        listaEspera.forEach(nomeVoltou => {
            if (!nomes.includes(nomeVoltou)) {
                nomes.push(nomeVoltou);
            }
        });
    ...
    if(listaEspera.length > 0){
        ...
        if(listaEspera.length == 0) {
            ...
            if(document.getElementById('butVoltar').style.display == 'block'){
                ...
                butVoltarTodos.style.display = 'block';
            }
         }
    }else{
        ...
        butEspera.style.display = 'none';
        butVoltarTodos.style.display = 'none';
        if(controleLista == 0){
            renderizarLista();
            atualizarContadorEspera();
        }
...
function limparCadastrados(){
    if(cadastrados.length > 0){
        ...
        confirme.onclick = () => {
            ...
            atualizarContadorCadastrados();
            fechar();
            mostrarErro(`✅ ${erroExcluirTodosCadastrados}`);
        }
    }
}
...
function salvarInformacao() {
    ...
    if (!novaIgreja || !novaCidade) {
        mostrarErro(`⚠️ ${erroPreenchimento}`, false);
        return;
    }
